...
loop2:
  ...
  @ decrement r5 by 4 if it doesn't equal 0
  sub r5, r5, #2
  ...
  @ load the value of A[i][j+2] into r6
  add r7, r5, #2
  ldr r6, [r1, r4, lsl #2]
  ldr r6, [r6, r7, lsl #2]

  @ load the valuse of B[i][j+2] into r7
  add r8, r5, #2
  ldr r7, [r2, r4, lsl #2]
  ldr r7, [r7, r8, lsl #2]
  ...
  @ load address of C[i][j+2] into r9
  ldr r9, [r0, r4, lsl #2]
  ...
  @ load the value of A[i][j+3] into r6
  add r7, r5, #3
  ldr r6, [r1, r4, lsl #2]
  ldr r6, [r6, r7, lsl #2]

  @ load the valuse of B[i][j+3] into r7
  add r8, r5, #3
  ldr r7, [r2, r4, lsl #2]
  ldr r7, [r7, r8, lsl #2]
  ...
  @ load address of C[i][j+3] into r9
  ldr r9, [r0, r4, lsl #2]
